...
class TestCaptureLayers:
    ...
    def test_captures_keyword_called_layers(self, toy_adapter_kwargs, toy_input):
        ...
        blocks = toy_adapter_kwargs.layers
        with capture_layers(toy_adapter_kwargs) as cache:
            toy_adapter_kwargs.forward_frozen(toy_input, None, 5)
        assert len(cache) == toy_adapter_kwargs.n_layers + 1 == 4
